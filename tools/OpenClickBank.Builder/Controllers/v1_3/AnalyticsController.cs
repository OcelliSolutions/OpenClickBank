...
public class AnalyticsController : ControllerBase
{
    ...
    public ActionResult GetSubscriptionTrends(
        [Required, SwaggerParameter(Description = "A valid role")] RoleAccount role,
        [FromHeader, SwaggerParameter(Description = "The page number of the results (default is page 1).")] int? page,
        [Required, FromQuery, SwaggerParameter(Description = "The account nickname/site.")] string account,
        ...
        [Required, FromQuery, SwaggerParameter(Description = "The end date (inclusive) of the time frame to report on - format is yyyy-MM-dd.")] DateTime? endDate) => Ok();
...
VENDOR_PRODUCT_SKU – Only available if role = AFFILIATE")] Dimension dimension,
        ...
        [FromQuery, SwaggerParameter(Description = "When an order by is included this may be specified with a value of true to sort ascending instead of descending")] bool? sortAscending) => Ok();
