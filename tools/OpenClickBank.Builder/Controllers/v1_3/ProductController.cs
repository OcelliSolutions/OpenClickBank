...
public class ProductController : ControllerBase
{
    ...
    public ActionResult GetProducts(
        ...
        [FromQuery, SwaggerParameter(Description = "The product types to return.d Must be either STANDARD or RECURRING. Will return all types if not specified.")] ProductType? type) => Ok();
}
